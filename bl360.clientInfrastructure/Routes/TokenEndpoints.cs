...
namespace bl360.clientInfrastructure.Routes
{
    public static class TokenEndpoints
    {
        ...
        public static string Refresh = BaseEndpoint.BaseURL + "Authentication/RefreshLogin";

        public static string AuthenticateURL = BaseEndpoint.BaseURL + "Authentication/Authenticate";
        public static string SuperviserApprovalURL = BaseEndpoint.BaseURL + "Authentication/SuperviserApproval";
        ...
        public static string CompanyDefaultDetailsURL = BaseEndpoint.BaseURL + "Company/getCompanyCurrencyCode";
        ...
        public static string RecallOrder = BaseEndpoint.BaseURL + "Order/FindHoldOrders ";
        ...
        public static string ItemRateEndPoint { get; set; } = BaseEndpoint.BaseURL + "Item/GetItemRateEx";
        ...
        public static string GetAssignedWorkStations = BaseEndpoint.BaseURL + "WorkStation/GetAssignedWorkstations";

        public static string HoldVoidTransaction = BaseEndpoint.BaseURL + "Transaction/HoldVoidTransaction";
        public static string UnHoldTransaction = BaseEndpoint.BaseURL + "Transaction/unHoldTransaction";
        public static string FindTransaction = BaseEndpoint.BaseURL + "Transaction/FindTransaction";
        public static string FindHoldTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/findHoldTransaction";
        public static string GetFromOrderToTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/GetFromPendingOrderToTransaction";
        public static string GetPriceListEndPoint = BaseEndpoint.BaseURL + "Transaction/PriceList";
        public static string GetAccountMappingERPPOS = BaseEndpoint.BaseURL + "Account/GetAccMappingByPaymentTypeERPPOS";
        ...
        public static string GetItemByItemCodeEndpoint { get; set; }  = BaseEndpoint.BaseURL + "Item/getItemByItemCode";
        public static string GetItemPromotionURL { get; set; } = BaseEndpoint.BaseURL + "Item/GetItemPromotion";
        ...
        public static string GetSalesReturnAgainstTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/GetSalesReturnAgainstTransaction";
        ...
        public static string StrartShift_EndPoint = BaseEndpoint.BaseURL + "HR/strartShift";
        public static string EndShift_EndPoint = BaseEndpoint.BaseURL + "HR/endShift";
        public static string CanStrartShift_EndPoint = BaseEndpoint.BaseURL + "HR/canStartShift";
        public static string CanEndShift_EndPoint = BaseEndpoint.BaseURL + "HR/canEndShift";
        public static string SalePresavingEndpoint = BaseEndpoint.BaseURL + "Transaction/SalesPreSavingValidation";
        public static string GetItemRateAndStockEndpoint = BaseEndpoint.BaseURL + "Item/getItemRateAndStockPOS";
        public static string LockTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/lockedTrnHdr";
        public static string UnLockTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/unLockTrnHdr";
        public static string CheckTransactionLockEndPoint = BaseEndpoint.BaseURL + "Transaction/checkTrnHdrIsLocked";
        public static string ShiftOrdKyUpdate_EndPoint = BaseEndpoint.BaseURL + "HR/shiftOrdKyUpdateEndPoint";
        public static string ShiftTrnKyUpdate_EndPoint = BaseEndpoint.BaseURL + "HR/shiftTrnKyUpdateEndPoint";
        public static string CheckOrdHdrIsLockedEndPoint = BaseEndpoint.BaseURL + "Order/checkOrdHdrIsLocked";
        public static string LockedOrdHdrEndPoint = BaseEndpoint.BaseURL + "Order/lockedOrdHdr";
        public static string UnLockOrdHdrEndPoint = BaseEndpoint.BaseURL + "Order/unLockOrdHdr";
        public static string StkRepVisitValidation_EndPoint = BaseEndpoint.BaseURL + "HR/StkRepVisitValidation";

        public static string Get_Remaining_Transaction_Quantity = BaseEndpoint.BaseURL + "Transaction/GetTransactionRemainQuantity";
        ...
        public static string ItmTrnVoidingEndPoint = BaseEndpoint.BaseURL + "Transaction/VoidItmTrnLineItem";
        public static string OrdDetVoidingEndPoint = BaseEndpoint.BaseURL + "Order/VoidOrderLineItem";
        public static string GetAccSetOffCreditTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/GetAccSetOffCreditTransaction";
        ...
        public static string RecpJournal_EndPoint = BaseEndpoint.BaseURL + "Payment/ReceiptJournalPosting";
        public static string GetDrSetOffDetails_EndPoint = BaseEndpoint.BaseURL + "Payment/DrAcctrnSelect";
        public static string GetCrSetOffDetails_EndPoint = BaseEndpoint.BaseURL + "Payment/CrAcctrnSelect";
        public static string SetOffSave_EndPoint = BaseEndpoint.BaseURL + "Payment/SaveSetoff";
        public static string AllSetOffSave_EndPoint = BaseEndpoint.BaseURL + "Payment/SaveAllSetoff";
        //lnd
        ...
        public static string CodeBaseDetailRequest { get; set; } = BaseEndpoint.BaseURL + "CodeBase/GetCodeDetail";
        public static string CodeBaseDetailByObjectRequest { get; set; } = BaseEndpoint.BaseURL + "CodeBase/GetCodeDetailByObject";
        ...
        public static string SaveWorkstation = BaseEndpoint.BaseURL + "WorkStation/CreateWorkStation";
        ...
        public static string GetAddressByAdrKyEndPoint2 = BaseEndpoint.BaseURL + "Address/selectSingleAddressByAdrKy";
        ...
        //OrderHub
        public static string HoldVoidOrder = BaseEndpoint.BaseURL + "Order/HoldVoidOrder";
        ...
        public static string CreateAdvanceAnalysisSimpleEndPoint = BaseEndpoint.BaseURL + "Address/createNewAddressSimple";
        public static string UpdateAdvanceAnalysis = BaseEndpoint.BaseURL + "Address/updateAddressSimple";
        ...
        public static string STKSalesOrderVsBgt_DashboardWebEndpoint = BaseEndpoint.BaseURL + "SalesAndProductivity/STKSalesOrderVsBgt_DashboardWeb";
        #endregion

        //for alerts
        public static string GetAlertsEndPoint = BaseEndpoint.BaseURL + "Notify/getAlerts";

        public static string GetAccDetailsBuPaymentModeWiseReceiptEndPoint = BaseEndpoint.BaseURL + "Transaction/getAccDetailsBuPaymentModeWiseReceipt";
        public static string GetRecieptsSetOffDetailsEndPoint = BaseEndpoint.BaseURL + "Transaction/GetRecieptsSetOffDetails";
        public static string SaveOrdAccountResponseExMultiCrnEndPoint = BaseEndpoint.BaseURL + "Order/SaveOrdAccountResponseExMultiCrn";
        public static string ItemSerialNumberURL = BaseEndpoint.BaseURL + "Item/readItemSerials";
        public static string SerialNumberRedeemValidURL = BaseEndpoint.BaseURL + "Item/validateSerialNumberRedeem";
        public static string GetLatestShiftDetailsEndpoint = BaseEndpoint.BaseURL + "HR/getLatestShiftForWorkstation";

        //for reports EndPoint
        public static string JouelInvoiceEndPoint = BaseEndpoint.BaseURL + "Report/getJouelInvoiceReport";
        public static string GetReportCompanyEndPoint = BaseEndpoint.BaseURL + "Report/getReportCompany";
        public static string GetShiftEndReportData = BaseEndpoint.BaseURL + "Report/getShiftEndReportData";
        public static string GetCashSummaryDetails = BaseEndpoint.BaseURL + "Report/getCashSummaryReport";
        public static string GetJouelTransPaymentDetails = BaseEndpoint.BaseURL + "Report/getJouelTransPaymentDetails";
        public static string GetAllCodesAndLocations = BaseEndpoint.BaseURL + "Report/GetAllCodeAndLocations";

        //payment voucher
        public static string AccTranInsertEndPoint = BaseEndpoint.BaseURL + "Payment/AccTranInsert";
        public static string OpenAccTransaction = BaseEndpoint.BaseURL + "Payment/AccTrnSelectWebEndPoint";
        public static string GetAddressesByAccKyEndpoint = BaseEndpoint.BaseURL + "Account/GetAddressesByAccKyEndpoint";

        public static string GetSalesOrderJouelReport = BaseEndpoint.BaseURL + "Report/getSalesOrderJouelReport";

        public static string OrderPreSaving = BaseEndpoint.BaseURL + "WorkShopManagement/carOrderPreSaving";

        public static string JouelAdvanceReceiptPaymentDetails = BaseEndpoint.BaseURL + "Report/joueladvancedreceiptpaymentmode";
        public static string ErrorLogEndpoint = BaseEndpoint.BaseURL + "Common/ErrorLogInsert";
        public static string AccTranPreSavingEndPoint = BaseEndpoint.BaseURL + "Payment/accTranPreSaveValidation";
        public static string GetFromTransactionToTransactionEndPoint = BaseEndpoint.BaseURL + "Transaction/GetFromTransactions";

        public static string AccountCreateSimpleEndPoint= BaseEndpoint.BaseURL + "Account/createNewAccountSimple";
        public static string AccountEditSimpleEndPoint = BaseEndpoint.BaseURL + "Account/updateAccountSimple";
    }
}